package com.wagerr.legacywallet.ui.words_restore_activity;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = wagerrModule.getAvailableMnemonicWordsList();
        ...
        if (current < layouts.length) {
            ...
            try {
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            wagerrModule.checkMnemonic(mnemonic);
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (wagerrApplication.getAppConf().getPincode() != null){
                                                        ...
                                                        if(!wagerrApplication.getAppConf().isAppInit()){
                                                            wagerrApplication.getAppConf().setAppInit(true);
                                                        }
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    dialog.setRightBtnTextColor(getColor(R.color.colorPrimary));
                }else {
                    dialog.setRightBtnTextColor(ContextCompat.getColor(this, R.color.colorPrimary));
                }
                dialog.show();
            } catch (Exception e) {
                e.printStackTrace();
