package com.wagerr.legacywallet.ui.transaction_send_activity.custom.outputs;
...
public class MultipleOutputsFragment extends BaseRecyclerFragment<OutputWrapper> {
        ...
        adapter = new BaseRecyclerAdapter<OutputWrapper, OutputHolder>(getActivity()) {
            ...
            protected void bindHolder(final OutputHolder holder, final OutputWrapper data, final int position) {
                ...
                if (data.getAddress()!=null){
                    ...
                    if (!wagerrModule.chechAddress(data.getAddress())) {
                        ...
                        if (s.length()>0){
                            if (holder.edit_address!=null) {
                                ...
                                if (!wagerrModule.chechAddress(address)) {
                                    ...
                                    AddressLabel addressLabel = wagerrModule.getAddressLabel(address);
    ...
    public void addOutput(){
        ...
        if (address==null || !wagerrModule.chechAddress(address)){
            // todo: mejorar esto
    ...
    public List<OutputWrapper> getList() throws InvalidFieldException {
        ...
        for (int i=0;i<list.size();i++){
            ...
            boolean checkAddress = address==null || !wagerrModule.chechAddress(address);
