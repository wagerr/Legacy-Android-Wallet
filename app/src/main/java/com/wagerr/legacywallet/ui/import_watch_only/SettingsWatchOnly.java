package com.wagerr.legacywallet.ui.import_watch_only;
...
import com.wagerr.legacywallet.ui.base.dialogs.DialogListener;
import com.wagerr.legacywallet.ui.base.dialogs.SimpleTextDialog;
import com.wagerr.legacywallet.utils.DialogsUtil;

import static com.wagerr.legacywallet.utils.CrashReporter.appendSavedBackgroundTraces;
...
public class SettingsWatchOnly extends BaseActivity {
    ...
    private void importXpub() {
        ...
        if (xpub.length()>0){
            try {
                wagerrModule.watchOnlyMode(
                        xpub,
                        isBip32 ? DeterministicKeyChain.KeyChainType.BIP32: DeterministicKeyChain.KeyChainType.BIP44_WAGERR_ONLY
                );
