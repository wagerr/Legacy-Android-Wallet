package com.wagerr.legacywallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = wagerrModule.backupWallet(backupFile, firstPassword);

            if (result){
                wagerrApplication.getAppConf().setHasBackup(true);
