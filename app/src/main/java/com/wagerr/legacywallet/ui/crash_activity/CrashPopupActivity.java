package com.wagerr.legacywallet.ui.crash_activity;
...
public class CrashPopupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        wagerrApplication.getAppConf().saveShowReportScreenOnStart(false);
    ...
    protected CharSequence subject(){
        return "Crash report"+" "+ wagerrApplication.getVersionName();
    }
    ...
    protected CharSequence collectWalletDump() throws IOException{
        return wagerrApplication.getModule().getWallet().toString(false,true,true,null);
    }
}
