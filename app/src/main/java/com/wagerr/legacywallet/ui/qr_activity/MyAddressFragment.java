...
import static com.wagerr.legacywallet.utils.AndroidUtils.copyToClipboard;
import static com.wagerr.legacywallet.utils.QrUtils.encodeAsBitmap;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(WagerrModule wagerrModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(wagerrModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = WagerrApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String wagerrURI = WagerrURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(wagerrURI,address.toBase58());
            }
    ...
    public void setModule(WagerrModule module) {
        this.module = module;
    }
